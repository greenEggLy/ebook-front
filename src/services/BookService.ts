...
export const GetBook = async (id: number): Promise<IBook> => {
...
export const addBook = async (newBook: IBook): Promise<Response> => {
...
export const modBook = async (book: IBook): Promise<Response> => {
