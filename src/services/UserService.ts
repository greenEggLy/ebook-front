...
import {IManUserInfo, IUser, IUserUinfo} from "../assets/Interface";
...
export const GetAllUsers = async (): Promise<IManUserInfo[]> => {
...
export const ModUserInfo_ADMIN = async (user_info: IManUserInfo) => {
