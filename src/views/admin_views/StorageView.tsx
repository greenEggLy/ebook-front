...
import {IBook, IMsg} from "../../assets/Interface";
...
import {addBook, DelBook, GetAllBook, modBook, ModBookCover,} from "../../services/BookService";
...
export const StorageView = () => {
    ...
    const [allData, setAllData] = useState<IBook[]>([]);
    ...
    const [newBook, setNewBook] = useState<IBook>(newData);
    ...
    const equals = (book1: IBook, book2: IBook) => {
    ...
    const defaultColumns: (ColumnTypes[number] & {
    ...
    })[] = [
        {
            ...
            width: "15%",
            // @ts-ignore
            render: (value, record: IBook, index) => (
                <img
                    onClick={() => {
    ...
    const handleSave = async (row: IBook) => {
        let newData = [...allData];
