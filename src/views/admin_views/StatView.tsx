...
import {IStatBookMoney, IStatBookSales, IStatUserMoney,} from "../../assets/Interface";
...
import {StatBookByMoney, StatBookBySales, StatUserByMoney,} from "../../services/StatService";
...
export const StatView = () => {
    ...
    const [userFilter, setUserFilter] = useState<IStatUserMoney[]>([]);
